...
from trucker_expenses.web.forms import CreateProfileForm, EditProfileForm, DeleteProfileForm, CreateExpenseForm, \
    EditExpenseForm, DeleteExpenseForm
from trucker_expenses.web.models import Profile, Expense
...
def delete_expense(request, pk):
    ...
    if request.method == 'POST':
        ...
        form = DeleteProfileForm(instance=expense)
    context = {
        'form': form,
        'expense': expense,
    }
